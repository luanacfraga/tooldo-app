...
import { AlertCircle, ArrowLeft, Building2, CheckCircle2, Edit, Plus, UserCog, Users } from 'lucide-react'
...
export default function TeamsPage() {
  ...
  const availableManagers = useMemo(() => {
    if (!managers.length || !teams.length) return managers

    const managerIdsInTeams = teams
  ...
  return (
    <PageContainer maxWidth="7xl">
      <PageHeader
        title={isManager ? 'Minhas Equipes' : 'Equipes'}
        description={
          isManager
